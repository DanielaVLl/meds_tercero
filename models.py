...
class Constants(BaseConstants):
    ...
    name_in_url = 'experimento_de_medicamentos3'  # name in webbrowser
...
class Player(BasePlayer):
    ...
    distrito = models.IntegerField(choices=[[1, 'Ancón'], [2, 'Ate Vitarte'], [3, 'Barranco'], [4, 'Breña'], [5, 'Carabayllo'],
                                           ...
                                           [41, 'Surquillo'], [42, 'Villa el Salvador'], [43, 'Villa María del Triunfo'], [44, 'Callao (distritos)']], label='Distrito de residencia')
